...
const allCourses = [
  ...
  { id: 5, skill: "Redes", title: "Configuração de Redes e Wi-Fi", provider: "INEFOP", url: "https://www.inefop.gov.ao", duration: "3 meses", level: "Técnico", free: true },
  { id: 6, skill: "Cibersegurança", title: "Cibersegurança e Firewalls", provider: "INESCOI", url: "https://www.inescoi.ao", duration: "40 horas", level: "Avançado", free: false },
  ...
  { id: 16, skill: "Python", title: "Python Fundamentos", provider: "CursosAngola", url: "https://cursosangola.com", duration: "4h", level: "Iniciante", free: true },
  { id: 17, skill: "SQL", title: "Base de Dados e SQL", provider: "CursosAngola", url: "https://cursosangola.com", duration: "2h", level: "Iniciante", free: true },
  { id: 18, skill: "Power BI", title: "Power BI — Dashboards e Relatórios", provider: "CursosAngola", url: "https://cursosangola.com", duration: "3h", level: "Intermédio", free: true },
  { id: 19, skill: "Figma", title: "Design de Interfaces com Figma", provider: "CursosAngola", url: "https://cursosangola.com", duration: "2h", level: "Iniciante", free: true },
  { id: 20, skill: "AWS", title: "AWS Cloud Concepts", provider: "CursosAngola", url: "https://cursosangola.com", duration: "3h", level: "Iniciante", free: true },
  { id: 21, skill: "Docker", title: "Docker e Containers", provider: "CursosAngola", url: "https://cursosangola.com", duration: "2h", level: "Intermédio", free: true },
  { id: 22, skill: "JavaScript", title: "JavaScript Essencial", provider: "CursosAngola", url: "https://cursosangola.com", duration: "3h", level: "Iniciante", free: true },
  { id: 23, skill: "React", title: "React — Desenvolvimento Web", provider: "CursosAngola", url: "https://cursosangola.com", duration: "4h", level: "Intermédio", free: true },
  { id: 24, skill: "Node.js", title: "Node.js e APIs REST", provider: "CursosAngola", url: "https://cursosangola.com", duration: "3h", level: "Intermédio", free: true },
  ...
  { id: 28, skill: "Scrum", title: "Scrum e Metodologias Ágeis", provider: "NEP Training", url: "http://www.neptraining.ao/", duration: "20 horas", level: "Intermédio", free: false },
  { id: 29, skill: "Comunicação", title: "Comunicação Efectiva no Trabalho", provider: "NEP Training", url: "http://www.neptraining.ao/", duration: "16 horas", level: "Básico", free: false },
  { id: 30, skill: "Java", title: "Java Fundamentos", provider: "CursosAngola", url: "https://cursosangola.com", duration: "4h", level: "Iniciante", free: true },
  { id: 31, skill: "TypeScript", title: "TypeScript para Developers", provider: "CursosAngola", url: "https://cursosangola.com", duration: "3h", level: "Intermédio", free: true },
  { id: 32, skill: "Firewall", title: "Administração de Firewalls", provider: "INESCOI", url: "https://www.inescoi.ao", duration: "30 horas", level: "Avançado", free: false },
  { id: 33, skill: "Suporte", title: "Suporte Técnico de Informática", provider: "INEFOP", url: "https://www.inefop.gov.ao", duration: "3 meses", level: "Técnico", free: true },
  { id: 34, skill: "Hardware", title: "Hardware e Manutenção de Computadores", provider: "INEFOP", url: "https://www.inefop.gov.ao", duration: "3 meses", level: "Técnico", free: true },
  { id: 35, skill: "CCTV", title: "Instalação de Sistemas CCTV e Segurança", provider: "INEFOP", url: "https://www.inefop.gov.ao", duration: "2 meses", level: "Técnico", free: true },
  { id: 36, skill: "Inglês", title: "Inglês para Negócios", provider: "NEP Training", url: "http://www.neptraining.ao/", duration: "3 meses", level: "Intermédio", free: false },
  { id: 37, skill: "PowerPoint", title: "PowerPoint — Apresentações Profissionais", provider: "CursosAngola", url: "https://cursosangola.com", duration: "1h", level: "Iniciante", free: true },
  { id: 38, skill: "DevOps", title: "DevOps e CI/CD", provider: "CursosAngola", url: "https://cursosangola.com", duration: "3h", level: "Avançado", free: true },
  { id: 39, skill: "Golang", title: "Go (Golang) Fundamentos", provider: "CursosAngola", url: "https://cursosangola.com", duration: "4h", level: "Intermédio", free: true },
  { id: 40, skill: "Microserviços", title: "Arquitectura de Microserviços", provider: "CursosAngola", url: "https://cursosangola.com", duration: "3h", level: "Avançado", free: true },
  { id: 41, skill: "PLC", title: "Programação de PLCs e Automação", provider: "INEFOP", url: "https://www.inefop.gov.ao", duration: "4 meses", level: "Técnico", free: true },
  { id: 42, skill: "Análise de Dados", title: "Análise de Dados com Python e SQL", provider: "CursosAngola", url: "https://cursosangola.com", duration: "4h", level: "Intermédio", free: true },
  { id: 43, skill: "Gestão", title: "Gestão e Liderança Empresarial", provider: "ISPA", url: "https://ispatlantida.co.ao/", duration: "1 ano", level: "Pós-Graduação", free: false },
  { id: 44, skill: "Engenharia Informática", title: "Engenharia Informática", provider: "ISPA", url: "https://ispatlantida.co.ao/", duration: "4 anos", level: "Licenciatura", free: false },
  { id: 45, skill: "Engenharia Civil", title: "Engenharia Civil", provider: "UAN", url: "https://fe.uan.ao/", duration: "5 anos", level: "Licenciatura", free: true },
  { id: 46, skill: "Redes", title: "Administração de Redes (CCNA)", provider: "NEP Training", url: "http://www.neptraining.ao/", duration: "3 meses", level: "Profissional", free: false },
  { id: 47, skill: "Segurança", title: "Segurança da Informação", provider: "INESCOI", url: "https://www.inescoi.ao", duration: "40 horas", level: "Avançado", free: false },
  { id: 48, skill: "Cloud", title: "Cloud Computing e Virtualização", provider: "INESCOI", url: "https://www.inescoi.ao", duration: "30 horas", level: "Avançado", free: false },
  { id: 49, skill: "Resolução de Problemas", title: "Resolução Analítica de Problemas", provider: "NEP Training", url: "http://www.neptraining.ao/", duration: "16 horas", level: "Intermédio", free: false },
  { id: 50, skill: "Trabalho em Equipa", title: "Trabalho em Equipa e Colaboração", provider: "NEP Training", url: "http://www.neptraining.ao/", duration: "12 horas", level: "Básico", free: false },
];
