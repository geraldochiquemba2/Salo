      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white/5 border-2 border-[#FACC15] p-4 sm:p-8 shadow-[8px_8px_0px_0px_rgba(249,115,22,0.5)]">
            ...
            <p className="font-display text-5xl sm:text-7xl text-[#FACC15]">{analysis.overallMatchScore}%</p>
          ...
          <div className="bg-white/5 border-2 border-[#F97316] p-4 sm:p-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white/5 border-2 border-white/10 p-4 sm:p-8">
            <h2 className="font-display text-2xl sm:text-4xl text-[#FACC15] uppercase mb-6">Cargos Recomendados</h2>
          ...
          <div className="bg-white/5 border-2 border-white/10 p-4 sm:p-8">
            <h2 className="font-display text-2xl sm:text-4xl text-[#FACC15] uppercase mb-6">Demanda de Mercado</h2>
            <div className="space-y-4">
