      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0A0A0A]/90 backdrop-blur-sm border-b border-[#FACC15]/20">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/empresas" className="text-[#FACC15] font-bold border-b-2 border-[#FACC15]">Empresas</Link>
            <Link href="/como-funciona" className="text-[#F5F0E8] hover:text-[#FACC15] transition-colors font-medium">Como Funciona</Link>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden bg-[#0A0A0A] border-t border-[#FACC15]/20 px-6 py-4 flex flex-col gap-4">
            ...
            <Link href="/empresas" className="text-[#FACC15] font-bold">Empresas</Link>
            <Link href="/como-funciona" className="text-[#F5F0E8] font-medium">Como Funciona</Link>
          </div>
        )}
      </nav>
            ...
            {plans.map((plan, i) => (
              <div key={i} className={`border-2 ${plan.accent} relative overflow-hidden ${plan.popular ? 'md:-mt-4 md:mb-4' : ''}`}>
                ...
                <div className="p-8">
                  ...
                  <Link href="/cadastro" className={`block text-center py-4 font-black uppercase tracking-wider transition-colors ${plan.popular ? 'bg-[#F97316] text-[#F5F0E8] hover:bg-[#FACC15] hover:text-[#0A0A0A]' : 'border-2 border-[#FACC15] text-[#FACC15] hover:bg-[#FACC15] hover:text-[#0A0A0A]'}`}>Começar Agora</Link>
                </div>
              </div>
            ))}
          </div>
